...
//
////import com.decagon.kindredhair.service.MailingService;
...
//     */
//    @Override
//    public boolean sendProfileRecommendation(String email, String emailLink) {
...
//                    .field("subject", "Hair Recommendation Link")
//                    .field("h:X-Mailgun-Variables", String.format("{\"View your Hair Recommendation\": \"%s\"}", emailLink))
//                    .asString();
